...
interface UploadBoxProps {
  ...
  icon: ReactNode
  value?: string
  onChange: (fileName: string, dataUrl?: string) => void
  accept?: string
  /** Dashed green border matches the address step; grey matches the identity step. */
  tone?: 'grey' | 'green'
  className?: string
}
          ...
          <>
            ...
            {preview ? (
              <img
                src={preview}
                alt=""
                className="mb-1 h-16 w-24 rounded-lg object-cover ring-1 ring-brand-200"
              />
            ) : (
