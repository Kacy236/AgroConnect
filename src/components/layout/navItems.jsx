...
export const FARMER_NAV = [
  ...
  { to: '/farmer/products/new', label: 'Add', icon: <Plus className="icon-28" />, fab: true },
...
export const FARMER_SIDEBAR = [
  { to: '/farmer', label: 'Home', icon: <Home className="icon-20" />, end: true },
  { to: '/farmer/products/new', label: 'Add Product', icon: <Plus className="icon-20" /> },
  { to: '/farmer/marketplace', label: 'Marketplace', icon: <Store className="icon-20" /> },
  { to: '/farmer/chats', label: 'Chats', icon: <MessageCircle className="icon-20" />, badge: 'chats' },
]
