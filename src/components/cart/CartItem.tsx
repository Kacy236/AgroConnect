...
export function CartItem({
  ...
  return (
    <li className="border-b border-ink-line py-5">
      <div className="flex items-center gap-4">
        <img
          src={product.image}
          alt={product.name}
          className="h-[70px] w-[92px] shrink-0 rounded-lg object-contain"
        />
      ...
      <div className="mt-2 flex items-center justify-between">
        <button
          type="button"
          onClick={onRemove}
          className="text-[17px] font-bold text-brand-600 transition hover:text-brand-700 hover:underline"
        >
          Remove
        </button>
