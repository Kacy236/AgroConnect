...
const OPTIONS: Array<{ role: Role; title: string; blurb: string; image: string }> = [
  {
    role: 'farmer',
    title: 'Farmer',
        ...
        {OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={cx(
                'flex w-full items-center gap-4 rounded-xl border p-3 text-left transition',
                active
            ...
            >
              <img
                src={option.image}
                alt=""
                className="h-[68px] w-[104px] shrink-0 rounded-lg object-cover"
              />
