...
const PLACEHOLDERS: Record<CategorySlug, string> = {
...
export function CreateProductPage() {
  ...
  function submit(e: React.FormEvent) {
    ...
    const slug =
      (CATEGORIES.find((c) => c.name === category)?.slug as CategorySlug | undefined) ??
      'vegetables'
    ...
    <>
      ...
      <form onSubmit={submit} noValidate className="mx-auto w-full max-w-2xl px-4 pb-12 lg:px-8">
        <div className="relative">
          <UploadBox
            accept="image/*"
            icon={<ImagePlus className="h-9 w-9 text-brand-600" />}
          ...
          />
          {imageUrl && !imageName ? (
            <div className="flex items-center gap-4 rounded-xl border border-ink-line p-3">
