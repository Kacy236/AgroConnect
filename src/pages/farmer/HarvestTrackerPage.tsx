        ...
        <section className="rounded-xl border border-brand-100 bg-brand-50/70 p-4">
          ...
          <div className="mt-3 flex items-center gap-4">
            <img
              src={upcoming.image}
              alt=""
              className="h-[72px] w-[92px] shrink-0 rounded-lg bg-white object-contain p-1"
            />
            ...
            {rest.map((h) => (
              <li key={h.id}>
                <Link
                  ...
                  className="flex items-center gap-4 rounded-xl border border-ink-line p-3 transition hover:border-brand-300"
                >
                  <img
                    src={h.image}
                    alt=""
                    className="h-[62px] w-[78px] shrink-0 rounded-lg object-contain"
                  />
                  <div className="min-w-0 flex-1">
