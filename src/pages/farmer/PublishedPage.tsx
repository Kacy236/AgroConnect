...
export function PublishedPage() {
  ...
  return (
        ...
        <div className="space-y-3">
          ...
          {product ? (
            <Button
              variant="ghost"
              block
              onClick={() => navigate(`/farmer/products/${product.id}`, { replace: true })}
            >
              View listing
            </Button>
          ) : null}
    ...
    >
      {product ? (
        <div className="mx-auto flex max-w-xs items-center gap-4 rounded-xl border border-ink-line p-3 text-left">
