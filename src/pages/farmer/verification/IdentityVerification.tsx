    ...
    >
      <form id="identity-form" onSubmit={submit} noValidate className="space-y-5">
        ...
        <div>
          ...
          <UploadBox
            className="mt-3"
            icon={<FilePlus2 className="h-9 w-9 text-brand-600" />}
            title="Tap to Upload"
          ...
          />
          {errors.document ? (
            <p className="mt-1 text-xs font-medium text-red-600">{errors.document}</p>
          ) : null}
        </div>
        ...
        <div>
          ...
          />
          {errors.selfie ? (
            <p className="mt-1 text-xs font-medium text-red-600">{errors.selfie}</p>
          ) : null}
        </div>
