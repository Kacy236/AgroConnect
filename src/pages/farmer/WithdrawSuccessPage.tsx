...
export function WithdrawSuccessPage() {
  ...
  const id = (location.state as { withdrawalId?: string } | null)?.withdrawalId
  ...
  return (
    <SuccessScreen
      ...
      description={
        <p className="font-bold text-ink-soft">Your withdrawal request has been submitted.</p>
      }
      actions={
    ...
    >
      {record ? (
        <section className="rounded-xl border border-ink-line p-5 text-left">
