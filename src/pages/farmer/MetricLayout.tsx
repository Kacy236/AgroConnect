...
import { EarningsChart, type ChartPoint } from '@/components/farmer/EarningsChart'
import { PageHeader } from '@/components/layout/Header'
import { cx } from '@/lib/utils'

export const PERIODS = ['This Week', 'This Month', 'This Year'] as const
  ...
  return (
    <label className="relative inline-flex">
      ...
      <select
        ...
        className="appearance-none rounded-lg border border-ink-line bg-white py-2.5 pl-4 pr-9 text-[15px] font-medium text-ink transition focus:border-brand-400 focus:outline-none"
      >
        {PERIODS.map((p) => (
...
export function Delta({ value }: { value: number }) {
  ...
  return (
    <p
      className={cx(
        'mt-1 flex items-center gap-0.5 text-[15px] font-bold',
