  ...
  return (
    <>
      ...
      <div className="mx-auto w-full max-w-4xl px-4 pb-12 lg:px-8">
        ...
        <div
          className="mx-auto mt-5 grid max-w-md grid-cols-2 rounded-xl border border-ink-line p-1"
          role="tablist"
        ...
        >
          <button
            ...
            className={cx(
              'rounded-lg py-3 text-[17px] font-bold transition',
          ...
          <button
            ...
            className={cx(
              'flex items-center justify-center gap-3 rounded-lg py-3 text-[17px] font-bold transition',
              yearly ? 'bg-white text-ink shadow-card' : 'bg-brand-50/70 text-ink-soft',
            )}
          >
            Yearly
          ...
          {PLANS.map((plan) => (
            <article
              ...
              className={cx(
                ...
                plan.highlight ? 'border-brand-200 bg-brand-50/70' : 'border-ink-line bg-white',
              )}
            >
