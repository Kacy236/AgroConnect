  ...
  return (
    <>
      ...
      <GreetingHeader
        ...
        accountHref="/buyer/account"
      />

      <div className="px-4 pb-10 lg:px-8">
        {/* Featured banner — desktop only, matching the design */}
        <Link
          to="/buyer/category/grains"
          className="mt-4 hidden overflow-hidden rounded-xl lg:block"
        >
          <img
        ...
        <div className="mt-4 flex items-center gap-3">
          ...
          <button
            ...
            className="flex h-[46px] w-[52px] shrink-0 items-center justify-center rounded-xl border border-ink-line text-ink transition hover:border-brand-300 hover:text-brand-600"
          >
          ...
          <>
            ...
            <section className="mt-6">
              <div className="mb-3 flex items-end justify-between gap-4">
                ...
                <Link
                  to="/buyer/category/vegetables"
                  className="flex items-center gap-1 text-[15px] font-semibold text-brand-600 hover:underline"
                >
                  See all
